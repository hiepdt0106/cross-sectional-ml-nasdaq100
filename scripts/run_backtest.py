...
def _engine_from_cfg(cfg, **overrides) -> BacktestEngineConfig:
    ...
    params = dict(
        ...
        regime_targeting=cfg.backtest.regime_targeting,
        ...
        breadth_gate=cfg.backtest.breadth_gate,
        ...
        benchmark_trend_gate=cfg.backtest.benchmark_trend_gate,
        ...
        vol_targeting=cfg.backtest.vol_targeting,
